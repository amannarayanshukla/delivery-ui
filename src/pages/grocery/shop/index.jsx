...
class Shops extends Component {
  ...
  componentDidMount() {
    // console.log(this.props, " : PROPS in shop holla aman");
  }

  render() {
    // console.log(this.props, "PROPS in SHOPS");
    ...
    return (
      <div>
        <div className={styles.header}>
          <h5>
            Powered by <span className={styles.company}>MOTABHAAI</span>
          </h5>
        ...
        <div id="shoppingCart" className={styles.shoppingCart}>
